...
WebViewPanel::WebViewPanel(wxWindow* parent) : wxPanel(parent, wxID_ANY, wxDefaultPosition, wxDefaultSize)
{
    ...
    */
    ...
    m_tools_menu->AppendSubMenu(editmenu, _L("Edit"));

    wxMenu* script_menu = new wxMenu;
    m_script_string     = script_menu->Append(wxID_ANY, _L("Return String"));
    m_script_integer    = script_menu->Append(wxID_ANY, _L("Return integer"));
    m_script_double     = script_menu->Append(wxID_ANY, _L("Return double"));
    m_script_bool       = script_menu->Append(wxID_ANY, _L("Return bool"));
    m_script_object     = script_menu->Append(wxID_ANY, _L("Return JSON object"));
    m_script_array      = script_menu->Append(wxID_ANY, _L("Return array"));
    m_script_dom        = script_menu->Append(wxID_ANY, _L("Modify DOM"));
    m_script_undefined  = script_menu->Append(wxID_ANY, _L("Return undefined"));
    m_script_null       = script_menu->Append(wxID_ANY, _L("Return null"));
    m_script_date       = script_menu->Append(wxID_ANY, _L("Return Date"));
    m_script_message    = script_menu->Append(wxID_ANY, _L("Send script message"));
    m_script_custom     = script_menu->Append(wxID_ANY, _L("Custom script"));
